...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //profile = Resources.Load<PostProcessingProfile>(_uiManager.analise.text + "Effect");
        }
        ...
        public PostProcessingProfile HappyEffect;
        ...
        void Update()
        {
            ...
            {
                profile = Resources.Load<PostProcessingProfile>(_uiManager.analise.text + "Effect");
                //GetComponent<PostProcessingBehaviour>().profile = HappyEffect;
            }
        }
